...
public class NewsConfig {
    ...
    CommandLineRunner commandLineRunner(NewsRepository newsRepository) {
        return args -> {
            News news1 = new News("1L", "test title1", LocalDate.parse("2021-10-12"), "https://test.com",
                    "https://img.jpg", "This is test object.");
            News news2 = new News("2L", "test title2", LocalDate.parse("2021-07-12"), "https://test.com",
                    "https://img.jpg", "This is test object.");
            News news3 = new News("3L", "test title3", LocalDate.parse("2021-09-12"), "https://test.com",
                    "https://img.jpg", "This is test object.");
